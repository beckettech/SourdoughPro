...
final class BakersPercentageTests: XCTestCase {
    ...
    func testAnnotatedPercentages() {
        ...
        XCTAssertEqual(flour.bakersPercent,   100, accuracy: 0.1)
        XCTAssertEqual(water.bakersPercent,    75, accuracy: 0.1)
        XCTAssertEqual(starter.bakersPercent,  20, accuracy: 0.1)
    }
